...
- [Temporal corpus scope](temporal-scope.md) — temporalRange in UIContext filters selectedLines/selectedSpeeches by year_est; sentinel 0–9999 → real bounds via useEffect on corpus load
